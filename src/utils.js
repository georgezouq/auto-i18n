...
async function setDefaultData(config = {}) {
    ...
    if (config.pluginImportFromThis !== undefined) globalData.pluginImportFromThis = config.pluginImportFromThis
    if (config.pluginImportPackage !== undefined) globalData.pluginImportPackage = config.pluginImportPackage
